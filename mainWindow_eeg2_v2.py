...
def serial_checker():
    ...
    ports_tot = len(sorted(ports))
    for x in range(ports_tot):
        for port in sorted(ports)[x]:
...
def initialize_eeg():
    ...
    loaded = load('/home/anjay123/relaxation-chair-GUI/model1.joblib')
...
class plotWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.ui = uic.loadUi('/home/anjay123/relaxation-chair-GUI/plot2.ui',self)
...
class tutorialWindow(QtWidgets.QMainWindow):
    def __init__(self):
        QtWidgets.QMainWindow.__init__(self)
        self.ui = uic.loadUi('/home/anjay123/relaxation-chair-GUI/tutorial2.ui',self)
        # self.ui = uic.loadUi('/home/san/Downloads/relaxation-chair-GUI-main/plot.ui',self)
...
class threading(QtWidgets.QMainWindow):
    def __init__(self):
        QtWidgets.QMainWindow.__init__(self)
        self.ui = uic.loadUi('/home/anjay123/relaxation-chair-GUI/sistem-kursi-relaksasi-v6-raspi2.ui',self)
        # self.ui = uic.loadUi('/home/san/Downloads/relaxation-chair-GUI-main/sistem-kursi-relaksasi-v6.ui',self)

        self.thread = {}
        self.tutorialButton.clicked.connect(self.tutorial_window)
...
### ------------------------- ###
    ...
    def start_default(self):
        ...
        self.volumeSpinBox.setDisabled(True)
        self.plotButton.setEnabled(False)
        self.tutorialButton.setEnabled(False)
        # self.MplWidget.canvas.axes.clear()
        # self.MplWidget.canvas.draw()
        # self.MplWidget2.canvas.axes.clear()
        # self.MplWidget2.canvas.draw()
        ...
        if self.x == 'Timer':
            ...
            if self.timeSpinBox.value() > 0:
                ...
                and self.thread5_state and self.thread6_state and self.thread7_state) == 0):
                    ...
                    print(serial_checker())
                    #if serial_checker() == '/dev/ttyUSB0':
                    if '/dev/ttyUSB0' in serial_checker():
    ...
    def stop_worker(self):
        ...
        self.tutorialButton.setEnabled(True)
        self.choosing_mode()
    ...
    def save_worker(self):
        ...
        file = open('/home/anjay123/111_DATA/'+date_now()+'_'+time_now()+'.csv', 'w', newline ='')
        with file:
        ...
        file = open('/home/anjay123/111_DATA/'+date_now()+'_'+time_now()+'.csv', 'a+', newline ='')
        with file:   
...
### ------------------------- ###
    ...
    def start_action_video(self,var2):
        ...
        self.ui.resize(1280,660) # 1920,1023 # 1024,540
    ...
    def start_action_getLoadcell(self,var2_1):
        ...
        # print(f'volume terkirim : {self.realtimeVol}')
...
class start_thread_getLoadcell(QtCore.QThread):
    ...
    def run(self):
        ...
        while (True):
            ...
            # print(f'vol : {vol}')
            self.any_signal3.emit(round(vol))
    def stop(self):
...
class start_thread_EEG(QtCore.QThread):
    ...
    def run(self):
        ...
        while self.keep_alive == True:
            ...
            self.any_signal5.emit(round(loaded.predict_proba([dataset])[0][0]*100))
...
# 4. Tutorial bikin window baru kek di window plot, jd bukan pop-up
    pass
