...
def initialize_eeg():
    global loaded,params,board,keep_alive,sampling_rate,delay,eeg_channel1,eeg_channel2,eeg_channel3,eeg_channel4,master_board_id,nfft
...
class threading(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.ui = uic.loadUi('/home/bimanjaya/learner/TA/relaxation-chair-GUI/sistem-kursi-relaksasi-v3.ui',self)
...
### ------------------------- ###
    ...
    def start_action_EEG(self,var2_3=0.0):
        self.eegData = var2_3
        self.realtimeEEG.setText(str(var2_3))
